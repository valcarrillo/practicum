...
var Tipo_C = document.getElementById('TipoCambio')

document.getElementById('STC').addEventListener('click',function(e){
    Tipo_C.disabled = false;
})
document.getElementById('NTC').addEventListener('click',function(e){
    Tipo_C.disabled = true;
})
